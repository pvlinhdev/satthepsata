                ...
                <div class="mg-footer-copyright">
                    ...
                    if($newsup_enable_footer_menu == true){ ?>
                            ...
                            <?php } ?>
								...
								printf( esc_html__( 'Chào mừng bạn đến với', '' ));
                                // printf( esc_html__( 'Sắt thép %1$s by %2$s.', 'newsup' ), 'Sata', '<a href="' . esc_url( __( 'https://themeansar.com/', 'newsup' ) ) . '" rel="designer">Themeansar</a>' );
								...
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Sắt thép Sata %s', 'newsup' ), '© 2023' );
								?>
								</a>
								</p>
                            </div>
